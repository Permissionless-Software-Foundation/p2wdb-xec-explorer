...
This is a fork of [react-bootstrap-web3-spa](https://github.com/Permissionless-Software-Foundation/react-bootstrap-web3-spa). It creates a visual explorer of database entries in the [pay-to-write database (P2WDB)](https://p2wdb.com).
